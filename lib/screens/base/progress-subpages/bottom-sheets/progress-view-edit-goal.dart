...
class ProgressViewEditGoalBottomSheet extends StatefulWidget {
  ...
  const ProgressViewEditGoalBottomSheet({
    super.key,
    required this.goal,
  ...
  @override
  State<ProgressViewEditGoalBottomSheet> createState() =>
          ...
          return Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Row(children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          _showDeleteConfirmation(context, progressController);
                        },
                        child: Container(
                          width: 36.w,
                          height: 36.w,
                        ...
                        GestureDetector(
                          ...
                          child: TextAutoSize(
                            ...
                            style: TextStyle(
                              ...
                              color:
                                  progressController.isFinancialGoalFormValid()
                                      ? nicotracklightBlue
                ...
                _buildEditableGoalFields(context, progressController),
          ...
          children: [
            Stack(
              children: [
                GestureDetector(
                  onTap: () {
                    controller.showEmojiPicker(context);
                  },
                  child: Container(
                    height: 120.w,
                    width: 120.w,
