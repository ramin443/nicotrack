...
class ProgressHealth extends StatefulWidget {
  const ProgressHealth({super.key});

  @override
  State<ProgressHealth> createState() => _ProgressOverviewState();
}

class _ProgressOverviewState extends State<ProgressHealth> {
  @override
        ...
        builder: (progressController) {
          return Column(
            ...
            children: [
              ...
              HealthImprovementTrend(
                scrollController: progressController.healthScrollViewController,
              ),
              SizedBox(
                height: 34.h,
              ),
              ...
              UpcomingHealthTrend(
                scrollController:
                    progressController.upcominghealthscrollController,
              ),
              SizedBox(
                height: 34.h,
              ),
