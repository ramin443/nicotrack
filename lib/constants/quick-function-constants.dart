...
List<AwardModel> allAwards =[
  AwardModel(emojiImg: badge1Emoji, day: 0),
  AwardModel(emojiImg: baseballImg, day: 1),
  AwardModel(emojiImg: pinataImg, day: 3),
  AwardModel(emojiImg: medalImg, day: 5),
  AwardModel(emojiImg: kiteImg, day: 8),
  AwardModel(emojiImg: golfImg, day: 14),
  AwardModel(emojiImg: dartarrowImg, day: 18),
  AwardModel(emojiImg: teddyImg, day: 21),
  AwardModel(emojiImg: hat2Img, day: 28),
  AwardModel(emojiImg: ballrollImg, day: 35),
  AwardModel(emojiImg: hatImg, day: 42),
  AwardModel(emojiImg: ballImg, day: 50),
  AwardModel(emojiImg: chocolateImg, day: 56),
  AwardModel(emojiImg: magicbowlImg, day: 65),
  AwardModel(emojiImg: crownImg, day: 75),
  AwardModel(emojiImg: vacayImg, day: 84),
  AwardModel(emojiImg: no1Img, day: 95),
  AwardModel(emojiImg: trophyImg, day: 105),
  AwardModel(emojiImg: drumrollImg, day: 112),
  AwardModel(emojiImg: capImg, day: 126),
  AwardModel(emojiImg: cablecarImg, day: 140),
  AwardModel(emojiImg: campingImg, day: 154),
  AwardModel(emojiImg: beachvacayImg, day: 168),
  AwardModel(emojiImg: rocketImg, day: 180),
];
